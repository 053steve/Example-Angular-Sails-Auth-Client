...
gulp.task('serve', ['wiredep', 'replace' , 'connect', 'fonts', 'watch'], function() {
  if (argv.open) {
...
gulp.src('app/scripts/core/constants/BackendConfig.js')
  ...
  .pipe(gulp.dest('app/scripts/core/constants/build/'));
});
